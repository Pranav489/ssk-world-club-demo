        ...
        {heroImages.length === 0 ? (
          <div className="absolute inset-0 bg-gradient-to-br from-[#0A2463] to-[#2E4052] flex items-center justify-center">
            <div className="text-center text-white">
              ...
              <p className="text-xl">Luxury facilities for our members</p>
            </div>
          </div>
        ) : (
          <>
            ...
            {amenities.length === 0 ? (
              <div className="text-center py-16">
                <div className="bg-gray-50 rounded-xl p-8 shadow-md max-w-md mx-auto">
                  ...
                  <h3 className="text-xl font-bold text-[#0A2463] mb-2">No Amenities Available</h3>
                  <p className="text-gray-600">Check back later for our luxury amenities.</p>
                </div>
              </div>
            ) : (
              /* Amenities Grid */
                  ...
                  >
                    ...
                    <div className="p-6">
                      <div className="flex items-center gap-4 mb-3">
                        <div className="bg-[#0A2463]/10 p-3 rounded-full text-xl">
