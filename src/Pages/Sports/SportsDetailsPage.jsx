...
const SportsDetailPage = () => {
  ...
  const [allImages, setAllImages] = useState([]); // Changed from additionalImages to allImages
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[#0A2463] font-medium">Loading sport details...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center p-8 bg-white rounded-xl shadow-md max-w-md mx-auto">
          ...
          <h3 className="text-xl font-bold text-[#0A2463] mb-2">Sport Not Found</h3>
          <p className="text-gray-600 mb-6">The sport you're looking for doesn't exist.</p>
          <button
